            ...
            <div class="section-content">
                ...
                <div class="product-grid">
                    <div class="product-item">
                        ...
                        <a href="producto.php?id=1" class="btn-secondary">Ver Más</a>
                    </div>
                    <div class="product-item">
                        ...
                        <a href="producto.php?id=2" class="btn-secondary">Ver Más</a>
                    </div>
                    <div class="product-item">
                        ...
                        <a href="producto.php?id=3" class="btn-secondary">Ver Más</a>
                    </div>
                </div>
            </div>
        </section>
